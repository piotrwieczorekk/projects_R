...
2. Decision trees are created. Usually the amount of trees ranges from 500 to 2000. Each decision tree is build based on the residuals from the prediction in step 1. So we would get only 0.5 and -0.5 residuals. 
