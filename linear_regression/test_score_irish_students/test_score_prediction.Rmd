...
```{r}
set.seed(123)
rf_reg <- randomForest(DVRT ~. -Type_school -Leaving_Certificate,data=train_set,ntree=28,mtry=1,importance=TRUE)
```
...
Linear model is slightly better than the random forest model because it explains slightly more variance and its Mean of squared residuals metric is lower
